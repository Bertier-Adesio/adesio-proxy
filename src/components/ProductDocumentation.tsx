...
const FALLBACK_DOC: DocContent = {
  ...
  playbook: {
    ...
    steps: [
      ...
      { num: '3', title: 'Adesio Assist', desc: 'AI enrichment for parts missing data, users upload (or link to) PDF datasheets. The AI automatically parses tables and text to extract missing parametric specs (Operating Temp, Package Type, RoHS compliance, etc.).' },
